...
const COMMENT_POOL = {
  ...
  speaking: {
    ...
    3: "Your child is a \"willing communicator.\" They keep conversations going even if they have to talk around a word they don't know. 孩子已是'积极沟通者'。即使遇到不会的词，也能通过变换表达来维持对话的持续。",
  ...
  pronunciation: {
    0: "We did not evaluate the student in this area.",
    1: "We are training the \"articulators\" for new shapes. The focus is on being understood, not on perfect accent yet. 我们正训练发音器官适应新的嘴型。重点在于表达的'清晰易懂'，而非立即追求地道口音。",
    ...
    3: "Your child is intelligible to most listeners. We are fine-tuning \"sentence rhythm,\" the key to sounding natural in English. 表达对大多数听众清晰易懂。我们正精细调整'句子节奏'，这是听起来自然地道的关键。",
  ...
  creative: {
    ...
    3: "Your child is moving beyond \"telling\" to \"showing.\" They are starting to use sensory details to paint a picture for the reader. 孩子正从'陈述'转向'描绘'。他们开始利用感官细节为读者勾勒画面。",
